    ...
    useEffect(() => {
        const fetchPolicy = async () => {
            try {
                ...
                const fallback = "<p>Unable to load Privacy Policy. Please try again later.</p>";
                setPolicyContent(fallback);
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    Your privacy is our priority — learn how DivinIQ securely
